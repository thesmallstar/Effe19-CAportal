    ...
    <div id="only-Landing">
      ...
      <nav>
        ...
        >
          <a
            id="logo-container"
            href="https://effe.org.in"
            className="brand-logo"
          >
            <img style={{ height: "60px", width: "60px" }} src={img1} />
          </a>
          <a
      ...
      <div id="index-banner" className="parallax-container">
        <div className="section no-pad-bot">
          <div className="container">
            ...
            <h1
              className="header center white-text text-lighten-2 intro"
              style={{ fontFamily: "Saira,sans-serif" }}
            >
              Campus Ambassador
            </h1>
            <div className="row center">
              <h5
                ...
                style={{ fontFamily: "Saira,sans-serif" }}
              >
                Register Now to be part of north's greatest fest!
              </h5>
            </div>
            <div className="row center">
              <a
                id="download-button"
                style={{ fontFamily: "Saira,sans-serif" }}
                className="btn-large waves-effect waves-light black lighten-1"
              >
                <Link style={{ color: "white" }} to="/auth/register-page">
                  Register
                </Link>
              </a>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <a
                ...
                className="btn-large waves-effect waves-light black lighten-1"
              >
                <Link style={{ color: "white" }} to="/auth/login-page">
                  Log In
                </Link>
              </a>
            </div>
        ...
        <div className="parallax">
          <img
            style={{
              opacity: "1",
              transform: "translate3d(-50%, -50px, -1px)"
            }}
            src={img2}
          ...
          <div className="row">
            <div className="col s12 center">
              ...
              <p className="left-align light">
                The CR system of Effervescence,IIIT Allahabad plays an integral
                part in its growth and promotions. It serves as a platform for
                binding Effervescence with the students across the country as
                well as imbibing their culture in our festival. It provides an
                opportunity to college students across the nation to stand out
                from multitude of people by being our voice in their respective
                colleges and thereby significantly bridging the gap between the
                two. So do register ,by associating with us as College
                Ambassadors and thereby moulding this edition of Effervescence
                bigger and glorious than ever before.
              </p>
            </div>
          </div>

          <div className="row shadow" id="roles">
            <div className="col s12 m4">
              <div className="icon-block">
                <h2 className="center green-text">
                  <i className="material-icons">group</i>
                </h2>
                <h5 className="center">Participation</h5>

                <p className="light">
                  It is only the Campus Ambassadors who are responsible to refer
                  other CA to the team Effervescence.Encourage and motivate the
                  people around to register and to show active participation in
                  the EFFE events.
                </p>
              </div>
            </div>
            ...
            <div className="col s12 m4">
              <div className="icon-block">
                ...
                <p className="light">
                  Promoting Effervescence,IIIT Allahabad on various other social
                  platforms like Twitter,Instagram and even various Facebook and
                  Whatsapp groups.
                </p>
              </div>
            </div>
            ...
            <div className="col s12 m4">
              <div className="icon-block">
                ...
                <p className="light">
                  The CAs are expected to coordinate with the EFFE team and help
                  us conduct the multicity program in your city(if selected)
                  along with managing public relations with Effervescence.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="page-footer black">
              ...
              <ul>
                ...
                <li style={{ display: "inline", padding: "15px" }}>
                  <a
                    ...
                    href="https://twitter.com/goeffervescence?lang=en"
                  >
                ...
                <li style={{ display: "inline", padding: "15px" }}>
                  <a
                    className="red-text"
                    href="https://instagram.com/goeffervescence"
                  >
        ...
        <div className="footer-copyright">
          <div className="container">
            <a
              style={{ color: "white" }}
              href="mailto:effervescence@iiita.ac.in "
            >
              effervescence@iiita.ac.in{" "}
            </a>
            <br />
            Festival Coordinators:
            <br />
            Yash Raj +(91)9934653679 <br />
